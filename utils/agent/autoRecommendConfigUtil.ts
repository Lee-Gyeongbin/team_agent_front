...
export const DEFAULT_AUTO_RECOMMEND_CONSTRAINTS = [
  ...
  '최근 24시간 이내 한국 커뮤니티 게시글/댓글 데이터를 기반으로, 반복적으로 사용되는 유행 표현, 신조어, 드립, 반응 표현, 유행 소재를 추출한다.',
  ...
  '이미지나 썸네일을 추측하지 말 것',
  '분석 기준 1: 최근 24시간 이내 반복 등장 빈도',
  '분석 기준 2: 여러 게시글/댓글에서 반복 사용 여부',
  '분석 기준 3: 댓글 반응 표현으로 소비되는지 여부',
  '분석 기준 4: 커뮤니티 전반 확산 여부',
  'points는 반드시 3줄 이상',
