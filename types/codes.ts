...
export const codesColumns: TableColumn[] = [
  { key: 'codeId', label: '코드', align: 'center', headerAlign: 'center' },
  { key: 'codeNm', label: '코드명', align: 'left', headerAlign: 'center' },
  { key: 'sortOrd', label: '정렬순서', width: '8%', align: 'center', headerAlign: 'center' },
  { key: 'useYn', label: '사용여부', width: '8%', align: 'center', headerAlign: 'center' },
  { key: 'description', label: '설명', width: '22%', align: 'left', headerAlign: 'center' },
  { key: 'etc1', label: '추가 정보1', width: '14%', align: 'left', headerAlign: 'center' },
  { key: 'etc2', label: '추가 정보2', width: '14%', align: 'left', headerAlign: 'center' },
